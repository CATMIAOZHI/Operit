...
/* METADATA
{
    ...
    "description": {
        "zh": "基于内置 dex-jar 运行时的 APK 逆向工具包，提供 inspect/decode/jadx/build/sign/search 等直调能力。JADX 支持独立进程隔离、内存耗尽时保留部分结果。",
        "en": "APK reverse toolkit backed by bundled dex-jar runtimes, providing direct inspect/decode/jadx/build/sign/search capabilities. JADX runs in an isolated process, keeps partial results when memory runs out."
    },
